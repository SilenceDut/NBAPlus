...
public abstract class ChartView extends RelativeLayout{
	...
	private int getLine() {
		...
		for(String line : horController.labels.get(0).split("\n")) {
			lineNumber++;
		}
		return lineNumber;
	}
	 ...
	 */
	public ChartView updateValues(int setIndex,String[] labels, float[] values){
		...
		data.get(setIndex).updateLablesAndValues(labels,values);
		return this;
	}
